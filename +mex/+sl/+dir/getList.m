...
s.folder_names = mex.sl.dir.getFileName(s.folder_paths);
...
file_names = mex.sl.dir.getFileName(file_paths);
...
s.file_names   = file_names;
s.folder_names = {};
s.file_paths   = mex.sl.dir.fullfileCA(root_folder_path,file_names);
s.folder_paths = {};
s.d_files      = d;
s.d_folders    = [];
...
s.file_paths   = {};
s.folder_paths = mex.sl.dir.fullfileCA(root_folder_path,folder_names);
s.d_files      = [];
s.d_folders    = d;
